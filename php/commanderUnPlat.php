...
function enregistrerUneCommande($conn, $platNum, $resNum, $dateRecup, $cliNum){
   ...
   $dureeTotal=$tab[0]["PLA_DUREE_PREPARATION"];
    ...
    var_dump($prixTotal);
    var_dump($tva);
   $sql="INSERT INTO rap_commande (res_num, com_num,  cli_num, com_date, com_heure_recup, com_prix_total, com_reduc_points, com_reduc_promo, com_duree_totale_prepa)VALUES ($resNum, (SELECT MAX(com_num) + 1 FROM rap_commande), '$cliNum', SYSDATE, TO_DATE('$dateRecup','hh24:mi:ss'), $prixTotal, $promo, $nbPoints, $dureeTotal)";
...
enregistrerUneCommande($conn, '100', 1, '20:00:00', '124');
?>